...
def upgrade() -> None:
    ...
    op.create_index("ix_llm_configurations_is_active", "llm_configurations", ["is_active"])
    op.create_index("ix_llm_configurations_priority", "llm_configurations", ["priority"])
    ...
    op.create_table(
        ...
        sa.Column("source_spec", postgresql.JSONB(astext_type=sa.Text()), default={}, nullable=False),
        sa.Column("target_spec", postgresql.JSONB(astext_type=sa.Text()), default={}, nullable=False),
        sa.Column("conversion_rules", postgresql.JSONB(astext_type=sa.Text()), default={}, nullable=False),
        sa.Column("system_prompt", sa.Text(), nullable=True),
        sa.Column("conversion_prompt_template", sa.Text(), nullable=True),
        sa.Column("validation_schema", postgresql.JSONB(astext_type=sa.Text()), default={}, nullable=False),
        sa.Column("include_patterns", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        sa.Column("exclude_patterns", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        sa.Column("is_active", sa.Boolean(), default=True, nullable=False),
    ...
    op.create_index("ix_module_templates_module_type", "module_templates", ["module_type"])
    ...
    op.create_table(
        ...
        sa.Column("default_base_branch", sa.String(255), default="main", nullable=False),
        sa.Column("pr_title_template", sa.String(512), default="[Module Converter] {module_name} - {action}", nullable=False),
        ...
        sa.Column("branch_prefix", sa.String(100), default="module-converter/", nullable=False),
        sa.Column("default_labels", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        sa.Column("default_reviewers", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        sa.Column("is_active", sa.Boolean(), default=True, nullable=False),
    ...
    op.create_index("ix_github_integrations_tenant_id", "github_integrations", ["tenant_id"])
    op.create_index("ix_github_integrations_is_active", "github_integrations", ["is_active"])
    ...
    op.create_table(
        ...
        sa.Column("llm_configuration_id", postgresql.UUID(as_uuid=False), nullable=True),
        ...
        sa.Column("output_data", postgresql.JSONB(astext_type=sa.Text()), default={}, nullable=False),
        ...
        sa.Column("llm_requests", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        ...
        sa.Column("result_artifacts", postgresql.JSONB(astext_type=sa.Text()), default=[], nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
            server_default=sa.text("now()"),
        ...
        sa.ForeignKeyConstraint(["llm_configuration_id"], ["llm_configurations.id"], ondelete="SET NULL"),
        sa.ForeignKeyConstraint(["initiated_by"], ["users.id"], ondelete="SET NULL"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("ix_module_conversion_logs_tenant_id", "module_conversion_logs", ["tenant_id"])
    op.create_index("ix_module_conversion_logs_job_id", "module_conversion_logs", ["job_id"])
    op.create_index("ix_module_conversion_logs_status", "module_conversion_logs", ["status"])
    op.create_index("ix_module_conversion_logs_template_id", "module_conversion_logs", ["template_id"])
    op.create_index("ix_module_conversion_logs_created_at", "module_conversion_logs", ["created_at"])
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["conversion_log_id"], ["module_conversion_logs.id"], ondelete="CASCADE"),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index("ix_conversion_steps_conversion_log_id", "conversion_steps", ["conversion_log_id"])
    op.create_index("ix_conversion_steps_step_number", "conversion_steps", ["step_number"])
