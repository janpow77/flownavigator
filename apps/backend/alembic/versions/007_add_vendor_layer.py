...
def upgrade() -> None:
    ...
    alert_type_enum = postgresql.ENUM(
        "warning", "critical", "exceeded", name="alert_type", create_type=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "licensed_authorities", sa.Integer(), nullable=False, server_default="1"
        ),
        ...
        sa.Column(
            "status", customer_status_enum, nullable=False, server_default="active"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "active_authorities", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
    ...
    op.create_unique_constraint(
        "uq_license_usages_customer_date", "license_usages", ["customer_id", "date"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["acknowledged_by"], ["vendor_users.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status", module_status_enum, nullable=False, server_default="development"
        ),
        ...
        sa.Column(
            "feature_flags", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "created_at",
            sa.DateTime(timezone=True),
        ...
        sa.ForeignKeyConstraint(
            ["developed_by"], ["vendor_users.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    ...
    op.create_table(
        ...
        sa.Column("customer_id", postgresql.UUID(as_uuid=False), nullable=False),
        sa.Column(
            "status", deployment_status_enum, nullable=False, server_default="pending"
        ),
        ...
        sa.ForeignKeyConstraint(["customer_id"], ["customers.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["deployed_by"], ["vendor_users.id"], ondelete="SET NULL"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        "ix_module_deployments_module_id", "module_deployments", ["module_id"]
    )
    op.create_index(
        "ix_module_deployments_customer_id", "module_deployments", ["customer_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "breaking_changes", postgresql.JSON(astext_type=sa.Text()), nullable=True
        ),
        sa.Column(
            "published_at",
            sa.DateTime(timezone=True),
