...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "country", sa.String(100), nullable=False, server_default="Deutschland"
        ),
        ...
        sa.Column(
            "primary_color", sa.String(7), nullable=False, server_default="#1e40af"
        ),
        sa.Column(
            "secondary_color", sa.String(7), nullable=False, server_default="#3b82f6"
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_coordination_body_profiles_tenant_id",
        "coordination_body_profiles",
        ["tenant_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column("logo_url", sa.String(512), nullable=True),
        sa.Column(
            "use_parent_branding", sa.Boolean(), nullable=False, server_default="true"
        ),
    ...
    op.create_index(
        "ix_authority_profiles_tenant_id", "authority_profiles", ["tenant_id"]
    )
